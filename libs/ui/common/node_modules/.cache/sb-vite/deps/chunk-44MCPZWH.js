...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-ZBFJMHRN.js";
import {
  ActionBar
} from "./chunk-VP5R7D6T.js";
import {
  ThemeProvider,
  convert,
  ensure,
...
} from "./chunk-ESJRXMVL.js";
import {
  stringify
} from "./chunk-WZTJ5IQO.js";
import {
  esm_default
} from "./chunk-DPULHH3L.js";
import {
  require_uniq
} from "./chunk-WIHGOVVP.js";
import {
  require_memoizerific
} from "./chunk-UOC6S5PC.js";
import {
  curriedDarken$1,
  curriedLighten$1,
  curriedOpacify$1,
  ...
  rgba
} from "./chunk-4HTGJITN.js";
import {
  require_pickBy
} from "./chunk-U5DLOVNS.js";
import {
  require_mapValues
} from "./chunk-BK52UDX4.js";
import {
  require_cloneDeep
} from "./chunk-R6J3N6TI.js";
import {
  renderElement,
  unmountElement
} from "./chunk-2UHWHQUG.js";
import {
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-67IZM7GX.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-PARCFPXK.js"));
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-V2KSITJR.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=chunk-44MCPZWH.js.map

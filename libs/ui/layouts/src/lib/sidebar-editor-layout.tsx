export function SidebarEditorLayout({
	...
	return (
		<div className="mx-auto grid max-w-[1920px] gap-8 xl:grid-cols-[500px_1fr]">
			<aside className="top-1 w-full border-t border-r-gray-200 pb-8 xl:sticky xl:h-[calc(100vh-61px)] xl:border-t-0 xl:border-r xl:overflow-y-auto">
				<div className="flex flex-col px-4 pb-32">
					<div className="flex flex-col gap-2 border-light-border pt-8 pb-4">
						{sidebar}
					</div>
				</div>
			</aside>

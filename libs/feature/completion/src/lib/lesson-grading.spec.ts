...
describe("calculateAverageQuizScore", () => {
	it("should return 0 when there are no attempts", () => {
		const attempts = {};
		const answers = {};
		const result = calculateAverageQuizScore(attempts, answers);

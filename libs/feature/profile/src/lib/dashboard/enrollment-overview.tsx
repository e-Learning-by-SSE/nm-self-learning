...
interface CourseEnrollmentOverviewProps {
	enrollments: EnrollmentDetails[] | null;
}

export function CourseEnrollmentOverview({ enrollments }: CourseEnrollmentOverviewProps) {
...
function SortedTable({ enrollments }: { enrollments: EnrollmentDetails[] }) {
	...
	// console.log("sortConfig", enrollments);

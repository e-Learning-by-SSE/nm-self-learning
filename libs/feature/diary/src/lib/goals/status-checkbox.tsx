	...
	return (
		<div className="flex p-1">
			<input
				...
				checked={checked}
				disabled={disabled}
				className={`flex grow aspect-square bg-c-surface-2 border-c-border-strong rounded dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 ${statusColorSettings}`}

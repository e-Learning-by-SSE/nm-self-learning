...
Das Nutzerprofil ist über den Unterpunkt ":icon:`user` Profil" im Hamburger-Menü erreichbar. Die Profilseite dient als persönliche Übersicht und Einstiegspunkt für weitere Funktionen.
...
Die Profilübersicht zeigt den Nutzernamen, die Anzahl abgeschlossener Lerneinheiten sowie ein Profilbild an. Über das :icon:`cog`-Icon können die :doc:`Nutzer-Einstellungen </settings>` geöffnet werden.
